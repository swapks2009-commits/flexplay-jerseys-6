export default function Hero() {
  return (
    <section className="pt-14 pb-10 text-center px-4" style={{ background: 'var(--bg-subtle)', borderBottom: '1px solid var(--border)' }}>
      <p className="text-sm md:text-base font-bold tracking-widest uppercase mb-3" style={{ 
      ...
      <p className="text-base max-w-xl mx-auto mb-7" style={{ color: 'var(--text-secondary)' }}>
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        ...
        <a href="https://wa.me/919156165683" target="_blank" rel="noopener noreferrer"
          className="px-6 py-2.5 rounded text-sm font-semibold text-white flex items-center gap-2 transition-opacity hover:opacity-90"
      ...
      {/* Trust strip */}
      <div className="flex flex-wrap justify-center gap-6 mt-8 text-xs" style={{ color: 'var(--text-muted)' }}>
