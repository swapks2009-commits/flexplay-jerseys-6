  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 bg-white transition-shadow duration-200 ${scrolled ? 'shadow-sm' : ''}`}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 h-14 flex items-center justify-between">
        {/* Logo */}
        <a href="#" className="flex items-center gap-2 font-bold text-lg tracking-tight" style={{ color: 'var(--text)' }}>
          <img 
        ...
        {/* Mobile */}
        <a href="https://wa.me/919156165683" target="_blank" rel="noopener noreferrer"
          className="md:hidden flex items-center gap-1.5 px-3 py-1.5 rounded text-white text-sm font-semibold"
          style={{ background: 'var(--wa-green)' }}>
          <WaIcon /> Order
        </a>
      </div>
